...
public class Gameplay_3P_Controller implements Initializable {
    ...
    Match match = new Match("User", 2) {

    };
    @FXML
    private AnchorPane AnchorPaneGamePlay_3P;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        setHandCardUser(match.players.get(2).handCard);
    ...
    void dropCardButton(MouseEvent event) {
        ...
        Player playerUser = match.players.get(2);
...
//        bot_3.setText(match.players.get(2).getName());
        user.setText(match.players.get(2).getName());
...
//        cardLeft_Bot_3.setText(String.valueOf(match.players.get(2).handCard.size()));
        cardLeft_User.setText(String.valueOf(match.players.get(2).handCard.size()));
...
//            cardButton_6.setVisible(true);
    ...
    public ArrayList<Card> setDroppedCard(int indexChooseCard) {
        ...
        droppedCard.clear();
        for (Card card : match.players.get(2).handCard) {
            if (card.getRank().equals(match.players.get(2).handCard.get(indexChooseCard).getRank())) {
...
//                sleep(1);
                ...
                try {
                    ...
                    Logger.getLogger(Gameplay_3P_Controller.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }
        checkDrawCard = false;
        ...
        setHandCardUser(match.players.get(2).handCard);
        match.players.get(2).displayHandCard();
    }
